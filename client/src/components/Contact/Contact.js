                    ...
                    {!loadMap ? <div>Loading...</div> : <Map />}
                        ...
                        <div className="row">
                            <div className="col-sm-6 ml-auto contact-btn">
                                    <a className="text-decoration-none text-dark" href="https://www.instagram.com/golfandbounce/" target="blank"><i className="fab fa-instagram fa-4x"></i>
                                <p className="text-center">Instagram</p>
                                </a>
                            </div>
                            <div className="col-sm-6 ml-auto contact-btn">
                                <a className="text-decoration-none text-dark" href="mailto:golfandbounce@gmail.com" target="blank"><i className="fas fa-envelope-open-text fa-4x"></i>
